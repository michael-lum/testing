...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) { // We encountered a new <node...> tag.
            activeState = "node";
        ...
        } else if (qName.equals("way")) { // We encountered a new <way...> tag.
            activeState = "way";
            //System.out.println("Beginning a way...");
            wayInfo.clear();
            connections.clear();

        } else if (activeState.equals("way") && qName.equals("nd")) { // While looking at a way, we found <nd...> tag.
